...
export default {
    ...
    mounted () {
        ...
        // this.inputText = "The chart of Amazon.com Inc. (AMZN) shows a double top pattern that formed in the stock between September and October 2018. After the pattern appears, shares plunges another 31%.";
