...
<template>
    <div style="height: 100%; width: 100%; font-family: Arial, Helvetica, sans-serif;">
        <div style="font-family: KoHo; text-align: start; font-size: 22px;height: 40px; font-weight: bold;">
            ...
            <img src="../assets/img/2.png" width="25" alt=""> &nbsp;Narrative Panel
            <hr>
        </div>
        <div style="height: calc(100% - 40px); widows: 100%;">
                ...
                <div style="height: 100%; width: 100%; display: flex;">
                    ...
                    <div style="width: 40px;">
                        <transition name="fade">
                            <button :class="['btn', { 'btn-green': hasInput }]" @click="submitText(1)">
                            ...
                            <div style="display: flex; justify-content: space-between">
                                <div>
                                    ...
                                    <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24"
                                        stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4" height="15"
                            ...
                            <div v-else v-loading="item.loading"
                                ...
                                <div>
                                    ...
                                    <!-- <span v-for="(o, i) in item.outputTextGroup" :key="'res_' + i"
                                        ...
                                        'border-bottom': o.tag == 2 || o.tag == 1 || o.tag == 3 ? '3px' + (o.tag == 3 ? ' solid ' : ' solid ') + o.color : '0px'
                                        }" @click="o.tag != -1 ? hoverObject(o) : ''"
                                        @mouseenter="o.tag != -1 ? handleHover(o) : ''"
            ...
            <div style="text-align: start; position: absolute; bottom: 0px; width: 100%; height: 40px;">
                <div style="height: 100%; width: 100%; display: flex;">
                    <div style="width: calc(100% - 40px)">
                        <el-input v-model="inputText" type="textarea" placeholder="Send a message" style="width: 100%;"
...
export default {
    ...
    mounted () {
        // this.inputText = "The New Energy Vehicle (NEV) market has undergone significant changes in recent years. In 2023, the sales proportion of NEVs that were subcompact and below declined to 30%, from 61% in 2017. During the same periods of comparison, the mix of compact and midsize-to-large NEVs increased to 70% from 39%, reflecting the upgrade trend in terms of vehicle size. The midsize-to-large NEVs achieved the highest sales proportion of 40% in 2023, indicating a significant shift in consumer preference towards to larger, more feature-rich NEVs. At the same time, both the subcompact and compact NEVs hit the sales proportion of 30%."
        this.inputText = "In light of the global shift towards sustainable energy, the Japan Electric Institute has made a forecast for future electricity generation sources. They predict that the renewables will continuously increase and reach 211 billion kilowatt hours in 2040. Meanwhile, natural gas, having reached 408 billion kilowatt hours in 2015, is predicted to consistently remain above 400 billion kilowatter hours. The liquid is predicted to reach 4 billion kilowatter hours in 2040. The nuclear energy in Japan, severely impacted by the Fukushima Daiichi nuclear disaster, recorded a production of only 3 billion kilowatt hours in 2015. Currently, due to its reliability and abundance, the most commonly used feedstock for electricity generation is now natural gas, which is expected to reach 438 billion kilowatt hours in 2040. It underscores the pivotal role of natural gas in Japan's energy landscape."
        this.submitText(0);
        const dataStore = useDataStore();
...
.dataObject {
    ...
    cursor: pointer;
    transition: 0.4s;
    /* border-image: url('../assets/img/1.png') 0 0 12 0 repeat; */
    /* border-color: bal; */
    border-style: solid;
    border: 1px black;
}
