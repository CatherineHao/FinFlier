<template>
    <div class="container">
        ...
        <span>
            &nbsp;R: <input class="rgbaInput" v-model="currentColor.r" placeholder="Please input" />
        </span>
        <span>
            &nbsp;G: <input class="rgbaInput" v-model="currentColor.g" placeholder="Please input" />
        </span>
        <span>
            &nbsp;B: <input class="rgbaInput" v-model="currentColor.b" placeholder="Please input" />
        </span>
        <span>
            &nbsp;A: <input class="rgbaInput" v-model="currentColor.a" placeholder="Please input" />
        </span>
    </div>
</template>
<script>
